    ...
    <Html lang="cs">
      ...
      <Body style={body}>
        <Container style={container}>
          <Section>
            <Text style={heading}>Potvrzení poptávky</Text>
            <Text style={text}>
              Vážený/á {contactName}, děkujeme za Vaši poptávku. Obdrželi jsme
              Váš požadavek ohledně: {subject}.
            </Text>
            <Text style={text}>
              Náš obchodní tým se Vám ozve do 24 hodin.
            </Text>
          </Section>
          <Hr style={hr} />
          <Section>
